...
import dev.norska.dwaddon.exp.update.UpdateChecker;
...
public class UpdateHandler {
	...
	public void checkForUpdates(EXPAddon main) {
	...
	public void sendUpdateMessage(EXPAddon main, CommandSender cms, Boolean join) {
		if (updateAvailable) {
				cms.sendMessage("");
